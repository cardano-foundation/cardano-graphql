...
module Cardano.Prelude.MemSize
  ( MemSize(..)
  , memSizeMb
  , memSizeKb
  , memSize0
...
memSize4
  :: (MemSize a3, MemSize a2, MemSize a1, MemSize a)
  => a
  -> a1
  -> a2
  -> a3
  -> Int
memSize5
  :: (MemSize a4, MemSize a3, MemSize a2, MemSize a1, MemSize a)
  => a
  -> a1
  -> a2
  -> a3
  ...
  -> Int
memSize6
  :: (MemSize a5, MemSize a4, MemSize a3, MemSize a2, MemSize a1, MemSize a)
  => a
  -> a1
  -> a2
  -> a3
...
memSize4 a b c d = 5 + memSize a + memSize b + memSize c + memSize d
memSize5 a b c d e =
  6 + memSize a + memSize b + memSize c + memSize d + memSize e
memSize6 a b c d e f =
  7 + memSize a + memSize b + memSize c + memSize d + memSize e + memSize f
...
memSize10 a b c d e f g h i j =
  11
    ...
    + memSize i
    + memSize j
memSize11 a b c d e f g h i j k =
  12
    + memSize a
    + memSize b
    + memSize c
    ...
    + memSize j
    + memSize k
memSize12 a b c d e f g h i j k l =
  13
    + memSize a
    + memSize b
    + memSize c
    ...
    + memSize k
    + memSize l
memSize13 a b c d e f g h i j k l m =
  14
    + memSize a
    + memSize b
    + memSize c
...
instance MemSize a => MemSize (Seq a) where
  memSize s = sum [ 5 + memSize v | v <- toList s ] --estimate
...
instance MemSize LByteString where
  memSize s = sum [ 1 + memSize c | c <- LBS.toChunks s ]

instance MemSize Text where
  memSize s = let (w,t) = divMod (length s) (wordSize `div` 2)
               in 5 + w + signum t
