...
describe('assets', () => {
  ...
  it('can return information on assets by fingerprint', async () => {
    const result = await client.query({
      ...
      variables: {
        where: {
          fingerprint: { _eq: 'asset132r28qxkhg0wddjjpt2qffzd9m7g37arndlxsv' }
        }
      }
    })
