...
self: super: {
  ...
  cron = haskell.lib.doJailbreak (haskell.lib.unmarkBroken super.cron);
  ...
  semigroups = self.callHackageDirect { pkg = "semigroups"; ver = "0.19.1"; sha256 = "0ng4j78di5p2yqx3m4bnfcz9cplp5px7d95374w2qxi20spjabpi"; } {};
